...
class _LegsPageState extends State<LegsPage> {
  ...
  final List<String> headerData = [
    "NEVER",
    "SKIP LEGS",
    "The foundation of every great physique. Squat deep, drive hard, grow everywhere.",
  ];
  ...
  Widget build(BuildContext context) {
    final filteredExercises = legsExercises.where((exercise) {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ExerciseWidget(data: legsExercises),
            ],
          ),
        );
      }).toList(),
