...
class _CorePageState extends State<CorePage> {
  ...
  final List<String> headerData = [
    "FORGE",
    "A STRONG CORE",
    "Your core is the engine behind every lift. Strengthen it and everything else follows.",
  ];
  ...
  Widget build(BuildContext context) {
    final filteredExercises = coreExercises.where((exercise) {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ExerciseWidget(data: coreExercises),
            ],
          ),
        );
      }).toList(),
